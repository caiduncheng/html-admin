...
import {appstoreApplicationCount} from '../../../../api/statistic'

export default {
  name: 'appstoreApplicationTotalCountChart',
  mixins: [resize],
  data () {
    return {
      series: [],
  ...
  methods: {
    initData (dateUnit, timeRange) {
      appstoreApplicationCount().then((res) => {
        var isEmpty = true
    ...
    initChart (data) {
      ...
      this.option = {
        ...
        legend: {
          // data: [this.$t('data_center.appstore_app_total_count')]
          data: ['Total number of applications in the application store']
        },
        toolbox: {
          show: true,
          feature: {
        ...
        series: [
          {
            name: 'Total number of applications in the application store',
            // name: this.$t('data_center.appstore_app_total_count'),
            type: 'bar',
            data: data.yaxisData
          }
        ]
