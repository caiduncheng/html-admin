...
import {tomsApplicationDailyDownloadTrend} from '../../../../api/statistic'
...
export default {
  ...
  methods: {
    initData (dateUnit, timeRange) {
      ...
      tomsApplicationDailyDownloadTrend(params).then((res) => {
        var isEmpty = true
    ...
    initChart (data) {
      ...
      this.option = {
        ...
        series: [
          {
            name: 'Number of new application downloads in the TOMS',
