...
export default {
  ...
  methods: {
    initData (dateUnit, timeRange) {
      ...
      operatorActivityTrend(params).then((res) => {
        var isEmpty = true
    ...
    initChart (data) {
      ...
      this.option = {
        ...
        legend: {
          ...
          // data: [this.$t('data_center.active_operator_count')]
        },
        toolbox: {
          show: true,
          feature: {
        ...
        series: [
          {
            // name: this.$t('data_center.active_operator_count'),
