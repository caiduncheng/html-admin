...
import {appstoreApplicationDownloadCount} from '../../../../api/statistic'

export default {
  name: 'appstoreApplicationDownloadTotalCountChart',
  mixins: [resize],
  data () {
    return {
      series: [],
  ...
  methods: {
    initData (dateUnit, timeRange) {
      ...
      appstoreApplicationDownloadCount(params).then((res) => {
        var isEmpty = true
    ...
    initChart (data) {
      ...
      this.option = {
        ...
        legend: {
          // data: [this.$t('data_center.appstore_app_download_total_count')]
          data: ['Total number of downloads of applications from the application Store']
        },
        toolbox: {
          show: true,
          feature: {
        ...
        series: [
          {
            // name: this.$t('data_center.appstore_app_download_total_count'),
            name: 'Total number of downloads of applications from the application Store',
            type: 'bar',
            data: data.yaxisData
          }
        ]
