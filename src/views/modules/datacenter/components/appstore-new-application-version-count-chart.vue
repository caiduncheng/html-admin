...
import {appstoreApplicationVersionTrend} from '../../../../api/statistic'

export default {
  name: 'appstoreNewApplicationVersionCountChart',
  mixins: [resize],
  data () {
    return {
      series: [],
  ...
  methods: {
    initData (dateUnit, timeRange) {
      ...
      appstoreApplicationVersionTrend(params).then((res) => {
        var isEmpty = true
    ...
    initChart (data) {
      ...
      this.option = {
        ...
        legend: {
          // data: [this.$t('data_center.appstore_new_app_version_count')]
          data: ['Number of new application versions in the application store']
        },
        toolbox: {
          show: true,
          feature: {
        ...
        series: [
          {
            ...
            name: 'Number of new application versions in the application store',
            type: 'line',
            data: data.yaxisData
          }
        ]
