...
import {applicationCount} from '../../../../api/statistic'

export default {
  name: 'tomsApplicationTotalCountChart',
  mixins: [resize],
  data () {
    return {
      series: [],
    ...
    initChart (data) {
      ...
      this.option = {
        ...
        legend: {
          ...
          data: ['Total number of TOMS applications']
        },
        toolbox: {
          show: true,
          feature: {
        ...
        series: [
          {
            // name: this.$t('data_center.toms_app_total_count'),
            name: 'Total number of TOMS applications',
            type: 'bar',
            data: data.yaxisData
          }
        ]
