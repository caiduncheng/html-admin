...
import {appstoreApplicationDailyDownloadTrend} from '../../../../api/statistic'

export default {
  name: 'appstoreNewApplicationDownloadCountChart',
  mixins: [resize],
  data () {
    return {
      series: [],
  ...
  methods: {
    initData (dateUnit, timeRange) {
      ...
      appstoreApplicationDailyDownloadTrend(params).then((res) => {
        var isEmpty = true
    ...
    initChart (data) {
      ...
      this.option = {
        ...
        legend: {
          // data: [this.$t('data_center.appstore_new_app_download_count')]
          data: ['Number of new application downloads in the application store']
        },
        toolbox: {
          show: true,
          feature: {
        ...
        series: [
          {
            name: 'Number of new application downloads in the application store',
            // name: this.$t('data_center.appstore_new_app_download_count'),
            type: 'line',
            data: data.yaxisData
          }
        ]
